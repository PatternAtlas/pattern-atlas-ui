...
(function ($) {
  ...
  jOWL.priv.Dt = function (options) {
    this.settings = $.extend({
      base: null, pattern: null, assert: function (b) {
        return true;
      }, match: function (a, b) {
        return true;
      }
  ...
  jOWL.Ontology.Datatype(__.xsd() + "integer", {
    sanitize: function (x) {
  ...
  jOWL.Ontology.Datatype(__.xsd() + "positiveInteger", {
    base: __.xsd() + "integer", assert: function (x) {
      return x > 0;
    }
  });
  ...
  jOWL.Ontology.Datatype(__.xsd() + "negativeInteger", {
    base: __.xsd() + "integer", assert: function (x) {
      return x < 0;
    }
  });
  jOWL.Ontology.Datatype(__.xsd() + "nonNegativeInteger", {
    base: __.xsd() + "integer", assert: function (x) {
      return x >= 0;
    }
  });
  jOWL.Ontology.Datatype(__.xsd() + "nonPositiveInteger", {
    base: __.xsd() + "integer", assert: function (x) {
      return x <= 0;
    }
  });
  ...
  jOWL.Ontology.Datatype(__.xsd() + "boolean", {
    sanitize: function (x) {
      if (typeof x == 'boolean') {
        return x;
      }
  ...
  jOWL.Ontology.Class.prototype = $.extend({}, jOWL.Ontology.Thing.prototype, {
    ...
    individuals: function () {
      ...
      var q = new jOWL.SPARQL_DL("Type(?x, " + this.name + ")").execute({
        async: false, onComplete: function (r) {
          arr = r.jOWLArray("?x");
        }
      });
      return arr;
  ...
  jOWL.options = {
    reason: true, locale: false, defaultlocale: 'en',
  ...
  jOWL.SPARQL_DL.prototype = {
    ...
    process: function (entry, resultobj, options) {
      var self = this;
      options = $.extend({
        chewsize: 10, async: true, onComplete: function (results) {
        }
      }, options);
      var q = entry[0];
      var sizes = {
