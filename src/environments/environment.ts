...
export const environment = {
  ...
  authorizeUrl: 'http://localhost:8080/realms/patternatlas/protocol/openid-connect/auth?',
  //authorizeUrl: 'http://localhost:8081/oauth/authorize?',
  tokenUrl: 'http://localhost:8080/realms/patternatlas/protocol/openid-connect/token',
  //tokenUrl: 'http://localhost:8081/oauth/token',
  tokenRevokeUrl: 'http://localhost:8080/realms/patternatlas/protocol/openid-connect/revoke',
  //tokenRevokeUrl: 'http://localhost:8081/oauth/revoke_token',
  signinUrl: 'http://localhost:8080/realms/patternatlas/clients-registrations/openid-connect',
  ...
  logoutUrl: 'http://localhost:8080/realms/patternatlas/protocol/openid-connect/logout?',
  // Account management
  accountManagementUrl: 'http://localhost:8080/realms/patternatlas/account?referrer=patternatlas',
