...
export class UndirectedEdgeModel extends Edge {
  ...
  pattern1Uri: string;
  pattern2Uri: string;
  pattern1PatternLanguageId: string;
  pattern2PatternLanguageId: string;
  ...
  constructor(p1: Pattern, p2: Pattern, patternlanguage: PatternLanguage, description: any, type: string, patternContainer: PatternContainer = null) {
    ...
    this.pattern1PatternLanguageId = p1.patternLanguageId;
    this.pattern2PatternLanguageId = p2.patternLanguageId;
  }
}
