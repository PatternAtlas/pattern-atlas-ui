...
import { LanguageRelation, Relation } from 'src/app/graph/model';
...
export class GroupClrLoaderService extends Loader<LanguageRelation> {
  ...
  async selectContentFromStore(uri?: string): Promise<any> {
    ...
    const graphs = [
     ...
     'https://purl.org/patternpedia/patternviews/cloudcomputingpatterns-enterpriseapplicationarchitecturepatterns-view/cloudcomputingpatterns-enterpriseapplicationarchitecturepatterns-view-Relations',
     'https://purl.org/patternpedia/patternviews/enterpriseapplicationarchitecturepatterns-enterpriseintegrationpatterns-view',
     'https://purl.org/patternpedia/patternviews/enterpriseapplicationarchitecturepatterns-enterpriseintegrationpatterns-view/enterpriseapplicationarchitecturepatterns-enterpriseintegrationpatterns-view-Relations'
    ];
