...
export class EnterpriseApplicationArchitecturePatternsModule {
  constructor(private cr: ComponentRegistryService) {
    ...
    // tslint:disable-next-line: max-line-length
    this.cr.registerComponent(UriConverter.doubleEncodeUri('https://purl.org/patternpedia/patternlanguages/enterpriseapplicationarchitecturepatterns#EnterpriseApplicationArchitecturePatterns'), {
      label: 'Network Graph',
