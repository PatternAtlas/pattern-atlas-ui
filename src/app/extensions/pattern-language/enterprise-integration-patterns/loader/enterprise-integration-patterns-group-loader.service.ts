...
export class EnterpriseIntegrationPatternsGroupLoaderService extends Loader<any> {
  ...
  async selectContentFromStore(): Promise<any> {
    ...
    const qry = `SELECT ?uri ?group ?pattern
      WHERE {
          ?uri <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://purl.org/patternpedia/enterpriseintegrationpatterns#EnterpriseIntegrationPatternRelationDescriptor> .
          ?uri <http://purl.org/patternpedia/enterpriseintegrationpatterns#hasLabel> ?group .
          ?uri <http://purl.org/patternpedia/enterpriseintegrationpatterns#hasPattern> ?pattern .
      }`;
